...
: ${AMENT_CURRENT_PREFIX:="/home/ros2user/raspbros2+my_ws/src/Myself_WS/Keyboard control for the Mellen car/install/speed_control_msgs"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/speed_control_msgs/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/speed_control_msgs/environment/library_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/speed_control_msgs/environment/path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/speed_control_msgs/environment/pythonpath.sh"
