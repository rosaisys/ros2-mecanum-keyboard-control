...
#include "ros_robot_controller_msgs/msg/detail/set_bus_servo_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_robot_controller_msgs::msg::SetBusServoState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_robot_controller_msgs::msg::SetBusServoState & ros_message)
{
  // Member: state
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_robot_controller_msgs
max_serialized_size_SetBusServoState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_robot_controller_msgs::msg::SetBusServoState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_robot_controller_msgs::msg::SetBusServoState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_robot_controller_msgs::msg::SetBusServoState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetBusServoState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_robot_controller_msgs::msg::SetBusServoState *>(
...
static size_t _SetBusServoState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetBusServoState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetBusServoState__callbacks = {
...
static rosidl_message_type_support_t _SetBusServoState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetBusServoState__callbacks,
...
get_message_type_support_handle<ros_robot_controller_msgs::msg::SetBusServoState>()
{
  return &ros_robot_controller_msgs::msg::typesupport_fastrtps_cpp::_SetBusServoState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_robot_controller_msgs, msg, SetBusServoState)() {
  return &ros_robot_controller_msgs::msg::typesupport_fastrtps_cpp::_SetBusServoState__handle;
}
